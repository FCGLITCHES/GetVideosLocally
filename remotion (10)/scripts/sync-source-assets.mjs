...
for (const [sourceRelative, targetName] of files) {
  ...
  try {
    ...
    throw new Error(
      `Missing source asset: ${sourceRelative}. Place "remotion (10)" directly inside the GetVideosLocally repository. No replacement UI will be fabricated.`
    );
  }
...
console.log('Asset sync complete: all product screenshots, logo and font came from GetVideosLocally.');
